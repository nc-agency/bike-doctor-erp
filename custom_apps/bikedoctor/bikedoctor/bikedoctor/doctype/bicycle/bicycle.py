# -*- coding: utf-8 -*-
# bike.doctor App für ERPNext - Bicycle DocType
# 
# Erstellt: 04.05.2025
# Änderungen:
# - Initiale Erstellung des Bicycle DocType für die bike.doctor-App
#
...
class Bicycle(Document):
    ...
    def get_maintenance_reminder(self):
        ...
        # Weitere Wartungslogik basierend auf Fahrradtyp, Alter und Nutzungsintensität
        # kann hier hinzugefügt werden für angepasste Wartungserinnerungen
